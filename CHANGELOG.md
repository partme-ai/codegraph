...
- Added Zig language support — parses `.zig` and `.zon` files with tree-sitter-zig, extracting functions, structs, enums, unions, opaque types, error sets, container fields, methods, variables, and `@import` references.
